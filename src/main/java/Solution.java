            ...
            for (int k = 0; k < size; k++) {
                ...
                if (current.i > 0 &&
                        (grid[nextN].charAt(current.j) == '.' || grid[nextN].charAt(current.j) == '@' ||
                                (grid[nextN].charAt(current.j) >= 'a' && grid[nextN].charAt(current.j) <= 'f' && state.contains(String.valueOf(grid[nextN].charAt(current.j))))) &&
                    ...
                    queue.add(new Cell(nextN, current.j, current.state));
                        ...
                        grid[nextN].charAt(current.j) <= 'F' && !visited.contains(nextN + " " + current.j + " " + current.state)) {
                ...
                if (current.i < grid.length - 1 &&
                        (grid[nextS].charAt(current.j) == '.' || grid[nextS].charAt(current.j) == '@' ||
                                (grid[nextS].charAt(current.j) >= 'a' && grid[nextS].charAt(current.j) <= 'f' && state.contains(String.valueOf(grid[nextS].charAt(current.j))))) &&
                    ...
                    queue.add(new Cell(nextS, current.j, current.state));
                        ...
                        grid[nextS].charAt(current.j) <= 'F' && !visited.contains(nextS + " " + current.j + " " + current.state)) {
                ...
                if (current.j > 0 &&
                        (grid[current.i].charAt(nextE) == '.' || grid[current.i].charAt(nextE) == '@' ||
                                (grid[current.i].charAt(nextE) >= 'a' && grid[current.i].charAt(nextE) <= 'f' && state.contains(String.valueOf(grid[current.i].charAt(nextE))))) &&
                    ...
                    queue.add(new Cell(current.i, nextE, current.state));
                        ...
                        grid[current.i].charAt(nextE) <= 'F' && !visited.contains(current.i + " " + nextE + " " + current.state)) {
                ...
                if (current.j < grid[current.i].length() - 1 &&
                        (grid[current.i].charAt(nextW) == '.' || grid[current.i].charAt(nextW) == '@' ||
                                (grid[current.i].charAt(nextW) >= 'a' && grid[current.i].charAt(nextW) <= 'f' && state.contains(String.valueOf(grid[current.i].charAt(nextW))))) &&
                    ...
                    queue.add(new Cell(current.i, nextW, current.state));
                        ...
                        grid[current.i].charAt(nextW) <= 'F' && !visited.contains(current.i + " " + nextW + " " + current.state)) {
